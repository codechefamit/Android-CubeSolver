package com.codechefamit.a_cubesolver;
       ...
       prevList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                switch (ch) {
                    ...
                    case 'W':
                        ...
                        break;
                    default:
                        Toast.makeText(MainActivity.this, "Error in picking color", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        btnSave.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                Toast.makeText(MainActivity.this,"Face Saved",Toast.LENGTH_SHORT).show();
                return true;
            }
        });
